...
/// Map the fork's `0x1982` mode onto OpenRoadie's [`BacklightMode`]. The source
...
/// Map the fork's `0x1982` status onto OpenRoadie's [`BacklightStatus`]. The
...
mod tests {
    ...
    #[test]
    fn firmware_modes_round_trip_through_roadie_modes() {
        assert_eq!(
