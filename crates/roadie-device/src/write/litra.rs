...
use roadie_core::device::{LightCapabilities, LightValueRange, LightValueUnit};
...
// `roadie_core::hid::light`; re-exported here unchanged so this module's
// own API surface doesn't churn.
pub use roadie_core::hid::light::LightCommand;
pub use roadie_device_registry::litra::{
