...
//!
//! The full protocol wrapper lives in `roadie-hidpp`; this module keeps the
//! OpenRoadie-facing compatibility API used by gesture/button orchestration:
...
/// [`ButtonId::DpiToggle`](roadie_core::binding::ButtonId::DpiToggle): the MX
...
/// [`ButtonId::Back`](roadie_core::binding::ButtonId::Back).
///
...
/// [`ButtonId::Forward`](roadie_core::binding::ButtonId::Forward).
///
/// Known CIDs:
