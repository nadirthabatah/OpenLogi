//! OpenRoadie's HID++ device layer: everything that knows Logitech's protocol
...
//! implementation per host HID API: `roadie-hid` over `async-hid`, a
...
pub use roadie_core::hid::smartshift;
pub use roadie_core::hid::smartshift::{
