...
const DEVICE_NAME: &str = "OpenRoadie action injector";
...
fn modifiers_to_keycodes(combo: &roadie_core::binding::KeyCombo) -> Vec<KeyCode> {
...
mod tests {
    use evdev::KeyCode;
    use roadie_core::binding::{KeyCombo, Shortcut};
