...
pub(super) fn updates_page(updater: Entity<Updater>) -> SettingPage {
    ...
    let toggles = SettingGroup::new()
        ...
        .item(
            ...
            .description(tr!(
                "Download updates in the background and apply them the next time OpenRoadie restarts."
            )),
        );
    ...
    SettingPage::new(tr!("Updates"))
        ...
        .resettable(false)
        .description(tr!(
            "Off by default — checking for updates is OpenRoadie's only optional outbound network request."
        ))
        .group(hero)
        .group(toggles)
        .group(source)
                            ...
                            h_flex()
                                ...
                                .child(
                                    div()
                                        ...
                                        .child(concat!("OpenRoadie ", env!("CARGO_PKG_VERSION"))),
                                )
    ...
    v_flex()
                    ...
                    v_flex()
                        ...
                        .child(
                            div()
                                ...
                                .text_color(pal.text_muted)
                                .truncate()
                                .child("github.com/AprilNEA/OpenRoadie/releases"),
                        ),
                )
                .child(
        ...
        .child(
            div()
                ...
                .text_color(pal.text_muted)
                .child(tr!(
                    "No background updater — OpenRoadie only connects when you turn on automatic checks or click Check for Updates."
                )),
        )
}
