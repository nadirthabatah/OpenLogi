...
impl SelectItem for AssetSourceOption {
    ...
    fn title(&self) -> SharedString {
        match self.source {
            ...
            AssetSourcePreference::OpenRoadie => SharedString::from("OpenRoadie"),
...
pub(super) fn asset_source_options() -> Vec<AssetSourceOption> {
    [
        ...
        AssetSourcePreference::OpenRoadie,
...
pub(super) fn assets_page(
    ...
    let group = SettingGroup::new()
        .item(
            ...
            .description(tr!(
                "Automatic uses the first healthy mirror. Choose a source to pin downloads; ROADIE_ASSETS still takes precedence."
            )),
        )
        .item(
            SettingItem::new(
            ...
            .description(tr!(
                "Fetch device renders from the selected source when a device connects. When off, OpenRoadie makes no asset network requests; bundled art and the silhouette still show."
            )),
        )
        .item(
            SettingItem::new(
