...
use gpui::App;
use roadie_core::device::{DeviceInventory, PairedDevice};
use roadie_core::diagnostics::{
...
use roadie_ipc::{InventoryHealth, PROTOCOL_VERSION};
...
fn connection_for(
    ...
    transports: Option<roadie_core::device::DeviceTransports>,
) -> ConnectionKind {
    match route {
