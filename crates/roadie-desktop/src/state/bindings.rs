...
use gpui::App;
use roadie_core::binding::{Action, Binding, ButtonId, GestureDirection};
use roadie_core::bindings::{bindings_for, hidpp_gesture_maps_for, oshook_gestures_for};
use roadie_core::config::{Config, KeyTrigger};
use tracing::debug;
...
pub(super) fn apply_thumbwheel_pair(
    ...
    config: &mut roadie_core::config::Config,
    persistent_key: Option<&str>,
    app: Option<&str>,
    pair: ThumbwheelPair,
) -> bool {
