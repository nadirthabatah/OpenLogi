...
OpenRoadie's vendored fork of the [`hidpp`](https://crates.io/crates/hidpp) crate —
...
OpenRoadie-specific changes live here; the source is otherwise kept close to
upstream to ease future syncs.

The crate is versioned with the OpenRoadie workspace (unified versioning), not
