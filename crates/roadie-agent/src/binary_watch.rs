...
mod tests {
    ...
    fn translocated_paths_are_recognised() {
        ...
        assert!(is_translocated(Path::new(
            "/private/var/folders/ab/xy/T/AppTranslocation/1E5A/d/OpenRoadie.app/Contents/MacOS/roadie-agent"
        )));
        assert!(!is_translocated(Path::new(
            "/Applications/OpenRoadie.app/Contents/Library/LoginItems/OpenRoadieAgent.app/Contents/MacOS/roadie-agent"
        )));
    }
}
