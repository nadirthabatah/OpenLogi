...
use roadie_agent_core::observable::ObservableState;
use roadie_agent_core::orchestrator::SharedRuntime;
use roadie_agent_core::receiver_access::{ExclusiveAccessReason, ExclusiveReceiverLease};
use roadie_agent_core::watchers::pairing::{self, Control, SessionEvent, SessionId};
use roadie_hid::{DiscoveredDevice, PairingEvent, ReceiverSelector};
use roadie_ipc::{FoundDevice, PairingCommandError, PairingFailure, PairingPhase, PairingUpdate};
...
mod tests {
    ...
    use roadie_agent_core::DpiCycles;
    use roadie_agent_core::receiver_access::ReceiverAccess;
    use roadie_agent_core::runtime::hook::HookMaps;
    use roadie_agent_core::runtime::scroll::ScrollPreferences;
    use roadie_core::config::VerticalScrollSensitivity;
    use roadie_hid::PairingError;
    ...
    fn shared_runtime() -> SharedRuntime {
        SharedRuntime {
            ...
            channel_registry: roadie_hid::ChannelRegistry::default(),
            channel_pool: roadie_hid::host::channel_pool(),
    ...
    fn discovered_device() -> DiscoveredDevice {
        DiscoveredDevice {
            address: [1, 2, 3, 4, 5, 6],
            authentication: 0,
            kind: roadie_hid::pairing::BoltDeviceKind::Unknown,
