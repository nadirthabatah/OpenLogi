...
use roadie_agent_core::event_monitor::EventMonitor;
use roadie_agent_core::observable::ObservableState;
use roadie_agent_core::orchestrator::{Orchestrator, SharedRuntime};
use roadie_agent_core::runtime::scroll::{ScrollInputHandle, ScrollRuntime};
use roadie_agent_core::runtime::{ActionDispatcher, ActionRuntime};
use roadie_agent_core::watchers::{self, gesture::GestureOutputs};
...
pub(crate) struct Core {
    ...
    pub(crate) demand: tokio::sync::mpsc::UnboundedReceiver<roadie_ipc::ClientKind>,
}
...
fn spawn_ipc_server(
    ...
    tokio::sync::mpsc::UnboundedReceiver<roadie_ipc::ClientKind>,
) {
...
fn seed_permission_facts(observable: &ObservableState) {
    ...
    observable.set_input_monitoring_granted(roadie_hid::permissions::has_access());
}
