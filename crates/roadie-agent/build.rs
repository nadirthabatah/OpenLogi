//! Build script for roadie-agent: embeds the Windows exe resources — the
...
//!
//! Kept in sync with the twin in `crates/roadie-desktop/build.rs` — only the
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription", "OpenRoadie Background Agent"
            VALUE "FileVersion", "{version}"
            VALUE "InternalName", "roadie-agent"
            VALUE "OriginalFilename", "roadie-agent.exe"
...
"#
    ...
    let rc_path = out.join("roadie-agent.rc");
