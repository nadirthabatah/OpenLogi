...
//!
//! The protocol-level `0x2111` wrapper lives in `roadie-hidpp`; this module
//! keeps OpenRoadie's IPC/config-facing mode and status types.
//!
...
/// (guarded by `roadie-ipc/tests/wire_format.rs`).
#[derive(
...
/// Snapshot returned from OpenRoadie's SmartShift read helpers.
///
