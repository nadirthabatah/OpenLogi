...
pub struct DeviceIdentity {
    ...
    /// Optional model-level identity in the OpenRoadie asset registry. This is
...
pub struct DeviceConfig {
    /// Whether OpenRoadie manages this device at all. `false` leaves the device
...
impl DeviceConfig {
    ...
    /// to nothing but the metadata OpenRoadie writes on its own: the probed
