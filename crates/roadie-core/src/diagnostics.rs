...
impl DiagnosticsReport {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        let _ = writeln!(out, "### OpenRoadie Diagnostics\n");
...
mod tests {
    ...
    fn assets() -> AssetInfo {
        AssetInfo {
            ...
            cache_path: "~/.local/share/roadie/assets".to_string(),
            bundle_present: true,
        }
    }
    ...
    fn renders_header_and_sections() {
        ...
        assert!(md.starts_with("### OpenRoadie Diagnostics"));
        ...
        assert!(md.contains("- OpenRoadie (GUI): v0.6.6 (release)"));
