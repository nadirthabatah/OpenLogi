...
impl Config {
    ...
    /// OpenRoadie should leave the device's current resolution unchanged.
    #[must_use]
    ...
    /// Set the wheel resolution OpenRoadie should restore for `device_key`.
    ...
    /// Whether OpenRoadie manages `device_key` at all (capture + volatile
    ...
    /// Enable or disable OpenRoadie's management of `device_key`.
