...
use roadie_device::inventory::persist::{ProbeCacheError, ProbeCacheSnapshot, ProbeCacheStore};
...
impl FileProbeCacheStore {
    ...
    pub fn in_data_dir() -> Option<Self> {
        match roadie_core::paths::data_dir() {
...
#[cfg(test)]
mod tests {
    use roadie_device::inventory::persist::{ProbeCacheSnapshot, ProbeCacheStore as _};
