...
// focused window. OpenRoadie's `gnome_shell` frontmost backend polls this to
...
const DBUS_NAME = 'org.roadie.Frontmost';
const DBUS_PATH = '/org/roadie/Frontmost';
const DBUS_INTERFACE = `
<node>
  <interface name="org.roadie.Frontmost">
...
export default class OpenRoadieFrontmostExtension extends Extension {
    enable() {
    ...
    // D-Bus method org.roadie.Frontmost.GetFocusedWmClass.
    GetFocusedWmClass() {
