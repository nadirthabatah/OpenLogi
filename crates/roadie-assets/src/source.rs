...
/// Mutable production endpoint behind the OpenRoadie custom domain.
...
/// npm asset release this OpenRoadie build understands.
...
pub enum AssetSource {
    ...
    JsDelivr,
    /// Explicit `ROADIE_ASSETS` or CLI `--base` override.
    Override(String),
}
